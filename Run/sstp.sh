...
#input perintah sstp
wget -O /usr/bin/add-sstp https://halucok.me/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://halucok.me/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://halucok.me/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://halucok.me/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
