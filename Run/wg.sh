...
# Tambahan
cd /usr/bin
wget -O add-wg "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/add-wg.sh"
wget -O del-wg "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/del-wg.sh"
wget -O cek-wg "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/cek-wg.sh"
wget -O renew-wg "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
