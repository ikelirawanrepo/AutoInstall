...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://halucok.me/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://halucok.me/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://halucok.me/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://halucok.me/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://halucok.me/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
