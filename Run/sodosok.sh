...
cd /usr/bin
wget -O add-ss "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/add-ss.sh"
wget -O del-ss "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/del-ss.sh"
wget -O cek-ss "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/cek-ss.sh"
wget -O renew-ss "https://github.com/ikelirawanrepo/AutoInstall/blob/main/Run/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
