...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/ikelirawanrepo/AutoInstall/main/Run/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/ikelirawanrepo/AutoInstall/main/Run/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/ikelirawanrepo/AutoInstall/main/Run/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/ikelirawanrepo/AutoInstall/main/Run/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
