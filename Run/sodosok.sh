...
cd /usr/bin
wget -O add-ss "https://halucok.me/add-ss.sh"
wget -O del-ss "https://halucok.me/del-ss.sh"
wget -O cek-ss "https://halucok.me/cek-ss.sh"
wget -O renew-ss "https://halucok.me/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
